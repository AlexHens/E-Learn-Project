...
class AdminChatScreen extends StatefulWidget {
  ...
  AdminChatScreen({Key? key, required this.idEmisor, required this.idReceptor, required this.reference, required this.nombreReceptor, required this.apellidosReceptor}) : super(key: key);
