...
class TeacherChatScreen extends StatefulWidget {
  ...
  TeacherChatScreen({Key? key, required this.idEmisor, required this.idReceptor, required this.reference, required this.nombreReceptor, required this.apellidosReceptor}) : super(key: key);
