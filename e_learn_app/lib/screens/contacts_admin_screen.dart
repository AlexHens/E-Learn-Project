...
class ContactsAdminScreen extends StatefulWidget {
  ...
  const ContactsAdminScreen({Key? key}) : super(key: key);
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  onTap: () async {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context) => AdminChatScreen(idEmisor: dataAdmin!.dni, idReceptor: dni, reference: referenceChatDatabase, nombreReceptor: nombre, apellidosReceptor: apellidos,)));
