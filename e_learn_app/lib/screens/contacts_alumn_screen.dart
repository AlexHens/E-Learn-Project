...
class ContactsAlumnScreen extends StatefulWidget {
   
  const ContactsAlumnScreen({Key? key}) : super(key: key);

  @override
  State<ContactsAlumnScreen> createState() => _ContactsAlumnScreenState();
}

class _ContactsAlumnScreenState extends State<ContactsAlumnScreen> {
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  onTap: () async {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context) => AlumnChatScreen(idEmisor: dataAdmin!.dni, idReceptor: dni, reference: referenceChatDatabase, nombreReceptor: nombre, apellidosReceptor: apellidos,)));
