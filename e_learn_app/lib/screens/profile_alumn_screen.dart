...
class ProfileAlumnScreen extends StatefulWidget {

  Usuario user_info;
   
  ProfileAlumnScreen({Key? key, required this.user_info}) : super(key: key);

  @override
  State<ProfileAlumnScreen> createState() => _ProfileAlumnScreenState();
}

class _ProfileAlumnScreenState extends State<ProfileAlumnScreen> {
