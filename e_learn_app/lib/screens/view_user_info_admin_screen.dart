...
class ViewUserInfoAdminScreen extends StatefulWidget {

  Usuario user_info;
   
  ViewUserInfoAdminScreen({Key? key, required this.user_info}) : super(key: key);

  @override
  State<ViewUserInfoAdminScreen> createState() => _ViewUserInfoAdminScreenState();
}

class _ViewUserInfoAdminScreenState extends State<ViewUserInfoAdminScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text('Usuarios', style: TextStyle(fontSize: 30,), textAlign: TextAlign.center, softWrap: true,)
        ),
        actions: [
